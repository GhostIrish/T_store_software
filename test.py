...
class SearchProductFrame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        tree_view = ttk.Treeview(self.tree_view_frame, columns=('id', 'product', 'product_type', 'size', 'gender', 'brand', 'buying_price', 'selling_price'), show='headings')
        ...
        tree_view.column('size', minwidth=100, width=100)
        tree_view.column('gender', minwidth=100, width=100)
        ...
        tree_view.heading('buying_price', text='BUYING PRICE')
        tree_view.heading('selling_price', text='SELLING PRICE')
